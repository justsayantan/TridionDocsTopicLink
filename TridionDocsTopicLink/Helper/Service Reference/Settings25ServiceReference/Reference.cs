...
namespace SDLKC2016WSSample.Settings25ServiceReference {
    ...
    public interface Settings {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://sdl.com/trisoft/2012/06/WebServices/Services/API25/Settings/GetTimeZone", ReplyAction="http://sdl.com/trisoft/2012/06/WebServices/Services/API25/Settings/GetTimeZoneRes" +
            "ponse")]
        [System.ServiceModel.FaultContractAttribute(typeof(SDLKC2016WSSample.Settings25ServiceReference.InfoShareFault), Action="http://sdl.com/trisoft/2012/06/WebServices/Services/API25/Settings/GetTimeZoneInf" +
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://sdl.com/trisoft/2012/06/WebServices/Services/API25/Settings/GetMetadata", ReplyAction="http://sdl.com/trisoft/2012/06/WebServices/Services/API25/Settings/GetMetadataRes" +
            "ponse")]
        [System.ServiceModel.FaultContractAttribute(typeof(SDLKC2016WSSample.Settings25ServiceReference.InfoShareFault), Action="http://sdl.com/trisoft/2012/06/WebServices/Services/API25/Settings/GetMetadataInf" +
            "oShareFault", Name="InfoShareFault", Namespace="http://sdl.com/trisoft/2012/06/WebServices/Contracts/Faults/API25/")]
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://sdl.com/trisoft/2012/06/WebServices/Services/API25/Settings/SetMetadata3", ReplyAction="http://sdl.com/trisoft/2012/06/WebServices/Services/API25/Settings/SetMetadata3Re" +
            "sponse")]
        [System.ServiceModel.FaultContractAttribute(typeof(SDLKC2016WSSample.Settings25ServiceReference.InfoShareFault), Action="http://sdl.com/trisoft/2012/06/WebServices/Services/API25/Settings/SetMetadata3In" +
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://sdl.com/trisoft/2012/06/WebServices/Services/API25/Settings/GetPossibleTar" +
            ...
            "getStatusesResponse")]
        [System.ServiceModel.FaultContractAttribute(typeof(SDLKC2016WSSample.Settings25ServiceReference.InfoShareFault), Action="http://sdl.com/trisoft/2012/06/WebServices/Services/API25/Settings/GetPossibleTar" +
        ...
        string GetPossibleTargetStatuses(SDLKC2016WSSample.Settings25ServiceReference.TargetStatus targetStatus, string ishObjectType, string[] userRoles, string fromStatus);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://sdl.com/trisoft/2012/06/WebServices/Services/API25/Settings/GetPossibleTar" +
            "getStatuses", ReplyAction="http://sdl.com/trisoft/2012/06/WebServices/Services/API25/Settings/GetPossibleTar" +
            "getStatusesResponse")]
        [return: System.ServiceModel.MessageParameterAttribute(Name="xmlLovValueList")]
        System.Threading.Tasks.Task<string> GetPossibleTargetStatusesAsync(SDLKC2016WSSample.Settings25ServiceReference.TargetStatus targetStatus, string ishObjectType, string[] userRoles, string fromStatus);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface SettingsChannel : SDLKC2016WSSample.Settings25ServiceReference.Settings, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class SettingsClient : System.ServiceModel.ClientBase<SDLKC2016WSSample.Settings25ServiceReference.Settings>, SDLKC2016WSSample.Settings25ServiceReference.Settings {
        ...
        public string GetPossibleTargetStatuses(SDLKC2016WSSample.Settings25ServiceReference.TargetStatus targetStatus, string ishObjectType, string[] userRoles, string fromStatus) {
            return base.Channel.GetPossibleTargetStatuses(targetStatus, ishObjectType, userRoles, fromStatus);
        }
        
        public System.Threading.Tasks.Task<string> GetPossibleTargetStatusesAsync(SDLKC2016WSSample.Settings25ServiceReference.TargetStatus targetStatus, string ishObjectType, string[] userRoles, string fromStatus) {
