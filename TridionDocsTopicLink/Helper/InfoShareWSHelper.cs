...
namespace TridionDocsTopicLink.Helper
{
    public class InfoShareWSHelper
    {
        ...
        public void Resolve()
        {
            ...
            this.proxyBinding = application25ServiceEndpoint.Binding;
        ...
        /// </summary>
        /// <returns>The proxy</returns>
        public SDLKC2016WSSample.Application25ServiceReference.Application GetApplication25Channel()
        {
            GuardToken();
            var client = new SDLKC2016WSSample.Application25ServiceReference.ApplicationClient(this.proxyBinding, new EndpointAddress(uris["Application25"]));
            return client.ChannelFactory.CreateChannelWithIssuedToken(this.issuedToken);
        }
        ...
        /// </summary>
        /// <returns>The proxy</returns>
        public SDLKC2016WSSample.Application20ServiceReference.Application GetApplication20Channel()
        {
            GuardToken();
            var client = new SDLKC2016WSSample.Application20ServiceReference.ApplicationClient(this.proxyBinding, new EndpointAddress(uris["Application20"]));
            return client.ChannelFactory.CreateChannelWithIssuedToken(this.issuedToken);
        }

        public SDLKC2016WSSample.PublicationOutput25ServiceReference.PublicationOutput GetPublication25Channel()
        {
            GuardToken();
            var client = new SDLKC2016WSSample.PublicationOutput25ServiceReference.PublicationOutputClient(this.proxyBinding, new EndpointAddress(uris["PublicationOutput25"]));
            return client.ChannelFactory.CreateChannelWithIssuedToken(this.issuedToken);
        }

        public SDLKC2016WSSample.PublicationOutput20ServiceReference.PublicationOutput GetPublication20Channel()
        {
            GuardToken();
            var client = new SDLKC2016WSSample.PublicationOutput20ServiceReference.PublicationOutputClient(this.proxyBinding, new EndpointAddress(uris["PublicationOutput20"]));
            return client.ChannelFactory.CreateChannelWithIssuedToken(this.issuedToken);
        }

        public SDLKC2016WSSample.DocumentObj25ServiceReference.DocumentObj GetDocumentObj25Channel()
        {
            GuardToken();
            var client = new SDLKC2016WSSample.DocumentObj25ServiceReference.DocumentObjClient(this.proxyBinding, new EndpointAddress(uris["DocumentObj25"]));
            return client.ChannelFactory.CreateChannelWithIssuedToken(this.issuedToken);
        }

        public SDLKC2016WSSample.DocumentObj20ServiceReference.DocumentObj GetDocumentObj20Channel()
        {
            GuardToken();
            var client = new SDLKC2016WSSample.DocumentObj20ServiceReference.DocumentObjClient(this.proxyBinding, new EndpointAddress(uris["DocumentObj20"]));
            return client.ChannelFactory.CreateChannelWithIssuedToken(this.issuedToken);
        }

        public SDLKC2016WSSample.Baseline25ServiceReference.Baseline GetBaseline25Channel()
        {
            GuardToken();
            var client = new SDLKC2016WSSample.Baseline25ServiceReference.BaselineClient(this.proxyBinding, new EndpointAddress(uris["Baseline25"]));
            return client.ChannelFactory.CreateChannelWithIssuedToken(this.issuedToken);
        }

        public SDLKC2016WSSample.Folder25ServiceReference.Folder GetFolder25Channel()
        {
            GuardToken();
            var client = new SDLKC2016WSSample.Folder25ServiceReference.FolderClient(this.proxyBinding, new EndpointAddress(uris["Folder25"]));
            return client.ChannelFactory.CreateChannelWithIssuedToken(this.issuedToken);
        }

        public SDLKC2016WSSample.User25ServiceReference.User GetUser25Channel()
        {
            GuardToken();
            var client = new SDLKC2016WSSample.User25ServiceReference.UserClient(this.proxyBinding, new EndpointAddress(uris["User25"]));
            return client.ChannelFactory.CreateChannelWithIssuedToken(this.issuedToken);
        }

        public SDLKC2016WSSample.Search25ServiceReference.Search GetSearch25Channel()
        {
            GuardToken();
            var client = new SDLKC2016WSSample.Search25ServiceReference.SearchClient(this.proxyBinding, new EndpointAddress(uris["Search25"]));
            return client.ChannelFactory.CreateChannelWithIssuedToken(this.issuedToken);
        }

        public SDLKC2016WSSample.TranslationJob25ServiceReference.TranslationJob GetTranslationJob25Channel()
        {
            GuardToken();
            var client = new SDLKC2016WSSample.TranslationJob25ServiceReference.TranslationJobClient(this.proxyBinding, new EndpointAddress(uris["TranslationJob25"]));
            return client.ChannelFactory.CreateChannelWithIssuedToken(this.issuedToken);
        }

        public SDLKC2016WSSample.ConditionManagement10ServiceReference.ConditionManagement GetConditionManagement10Channel()
        {
            GuardToken();
            var client = new SDLKC2016WSSample.ConditionManagement10ServiceReference.ConditionManagementClient(this.proxyBinding, new EndpointAddress(uris["ConditionManagement10"]));
            return client.ChannelFactory.CreateChannelWithIssuedToken(this.issuedToken);
        }

        public SDLKC2016WSSample.Settings25ServiceReference.Settings GetSettings25Channel()
        {
            GuardToken();
            var client = new SDLKC2016WSSample.Settings25ServiceReference.SettingsClient(this.proxyBinding, new EndpointAddress(uris["Settings25"]));
            return client.ChannelFactory.CreateChannelWithIssuedToken(this.issuedToken);
        }

        public SDLKC2016WSSample.EventMonitor25ServiceReference.EventMonitor GetEventMonitor25Channel()
        {
            GuardToken();
            var client = new SDLKC2016WSSample.EventMonitor25ServiceReference.EventMonitorClient(this.proxyBinding, new EndpointAddress(uris["EventMonitor25"]));
            return client.ChannelFactory.CreateChannelWithIssuedToken(this.issuedToken);
        }
